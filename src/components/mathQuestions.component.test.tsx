...
describe("MathQuestions", () => {
  it("renders single question", () => {
    const questions = [
      new MathQuestion(0, 2, 3, Operation.ADD),
    ];
  ...
  it("renders single question for subtraction", () => {
    const questions = [
      new MathQuestion(0, 5, 2, Operation.MINUS),
    ];
  ...
  it("renders single question for multiply", () => {
    const questions = [
      new MathQuestion(0, 3, 6, Operation.MULTIPLY),
    ];
  ...
  it("renders single question for divide", () => {
    const questions = [
      new MathQuestion(0, 9, 3, Operation.DIVIDE),
    ];
